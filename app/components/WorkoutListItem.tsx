...
const WorkoutListItem: React.FC<WorkoutListItemProps> = ({ workout }) => {
    ...
    return (
        ...
        >
            <CustomText size={theme.FontSizes.xxl} weight={theme.FontWeights.bold} color={theme.Colors.text}>
                {workout.name}
            </CustomText>

            <View style={styles.details}>
                <CustomText size={theme.FontSizes.medium} weight={theme.FontWeights.regular} color={theme.Colors.text}>
